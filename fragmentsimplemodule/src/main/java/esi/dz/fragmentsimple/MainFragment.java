...
public class MainFragment extends Fragment {
    ...
    ListView listView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)// dans l'autre il y'a void a la place de view

    {
        View view = inflater.inflate(R.layout.fragment_main, null);
        listView = (ListView) view.findViewById(R.id.listView);
        cutomAdapter = new CutomAdapter(view.getContext(), getBookList());
